...
class WordEmbedding(nn.Module):
    ...
    def __init__(self, word_embedding_config):
        super().__init__()
...
class Model(nn.Module):
    def __init__(self, args,  word_embedding_config, sentence_encoding_config,
                 pair_encoding_config, self_matching_config, pointer_config):
        super().__init__()
        self.embedding = WordEmbedding(word_embedding_config)

        self.r_net = RNet(args, self.embedding.embedding_size, word_embedding_config,
    ...
    def forward(self, question: Documents, passage: Documents):
        ...
        #print(embedded_passage.size())
        if torch.cuda.is_available():
            embedded_question = embedded_question.cuda()
            embedded_passage = embedded_passage.cuda()
            question = question
            passage = passage
...
class RNet(nn.Module):
    def __init__(self, args, embedding_size, word_embedding_config, sentence_encoding_config,
                 pair_encoding_config, self_matching_config, pointer_config):
        super().__init__()
